...
if(isset($_POST['simpan'])){
          ...
          $sql = "UPDATE tb_motor SET nomor_rangka='$nomor_rangka',merek='$merek',
          jenis_motor='$jenis_motor,tahun_motor='$tahun_motor',tanggal_pinjam='$tanggal_pinjam',
          tanggal_kembali='$tanggal_kembali' WHERE id_motor=$id";
          $query = mysqli_query($db, $sql);
